...
class ProcessService:
    ...
    def process_violation(self, image, camera_coordinates):
        ...
        print('List vehicles', list_vehicles)
        for vehicle in list_vehicles:
            license_plate_text = self.process_vehicle(image, vehicle)
